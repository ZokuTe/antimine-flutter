...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String get live_enable => 'Bilibili danmaku control';
  String get live_require_medal => 'Fan badge required';
  String get live_room_id => 'Room ID';
  String get live_room_id_hint => 'From the live page URL, short id is fine';
  String get live_sessdata => 'SESSDATA (optional)';
  String get live_sessdata_hint => 'Not needed. Anonymous works fine.';
  String get live_status => 'Status';
  String get live_status_off => 'Off';
  String get live_status_connecting => 'Connecting…';
  String live_status_connected({required Object RoomId}) =>
      'Connected · room ${RoomId}';
  String get live_status_retrying => 'Reconnecting…';
  String get live_commands =>
      'Commands: 上 下 左 右 move the cursor, 开 旗 问 act on it, with an optional count 1-9 (e.g. 3下开)';
  String get live_issue_unsupported_platform =>
      'Danmaku control is Windows / Linux only';
  String get live_issue_missing_room_id => 'Enter a room ID to connect';
  String get live_issue_disconnected => 'Disconnected, reconnecting…';
  String live_issue_network({required Object Detail}) =>
      'Can\'t reach Bilibili: ${Detail}';
  String live_issue_unavailable({required Object Detail}) =>
      'Unexpected response from Bilibili: ${Detail}';
  String live_issue_api_error({required Object Detail}) =>
      'Bilibili API error: ${Detail}';
  String get live_issue_room_not_found => 'Room not found or offline';
  String live_issue_auth_rejected({required Object Detail}) =>
      'Danmaku auth rejected: ${Detail}';
  ...
  String get background_image => 'Background Image';
